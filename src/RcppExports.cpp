...
RcppExport SEXP _FPOPdim2_FPOP2D(SEXP data1SEXP, SEXP data2SEXP, SEXP penaltySEXP, SEXP typeSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_FPOPdim2_FPOP2D", (DL_FUNC) &_FPOPdim2_FPOP2D, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_FPOPdim2(DllInfo *dll) {
