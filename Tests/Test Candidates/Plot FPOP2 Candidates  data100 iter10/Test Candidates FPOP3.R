...
######################################
png(filename = "Plot FPOP3 Candidats data100 iter10.png",  width = 1500, height = 1000)
...
dev.off()
write.table(means_candidates, "FPOP3 Candidates  data100 iter10.txt",  row.names = FALSE,col.names = FALSE  ) 
