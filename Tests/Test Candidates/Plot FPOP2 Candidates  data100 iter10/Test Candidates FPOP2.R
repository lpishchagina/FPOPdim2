...
#by default, nb_Iter = 10, size = 100
...
######################################
png(filename = "Plot FPOP2 Candidates  data100 iter10.png",  width = 1500, height = 1000)
...
dev.off()
write.table(means_candidates, "FPOP2 Candidates  data100 iter10.txt",  row.names = FALSE,col.names = FALSE  ) 
