...
######################################
png(filename = "Plot FPOP3 Candidats data10^5 iter10.png",  width = 1500, height = 1000)
...
write.table(means_candidates, "FPOP3 Candidates  data10^5 iter10.txt",  row.names = FALSE,col.names = FALSE  ) 
