CandidatesFPOP2 <- readLines(con = 'FPOP2 Candidates  data10^5 iter10.txt', n = -1)
CandidatesFPOP3 <- readLines(con = 'FPOP3 Candidates  data10^5 iter10.txt', n = -1)
...
png(filename = "Plot FPOP2 and FPOP3 Candidates comparison data10^5.png",  width = 1500, height = 1000)
