...
png(filename = "dim 12 PLOT FPOP 10^3 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[11]],ncol = 1)
dev.off()

png(filename = "dim 15 PLOT FPOP 10^3 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[1]],ncol = 1)
dev.off()

png(filename = "dim 2-15 PLOT FPOP 10^3 MultiTest Candidates.png",  width = 1500, height = 1000)
...
png(filename = "dim 2-5 PLOT FPOP 10^3 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[2]],PLOT_FPOP[[3]],PLOT_FPOP[[4]],PLOT_FPOP[[5]],ncol = 1)
dev.off()

png(filename = "dim 6-9 PLOT FPOP 10^3 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[6]],PLOT_FPOP[[7]],PLOT_FPOP[[8]],PLOT_FPOP[[9]],ncol = 1)
dev.off()

png(filename = "dim 10,12,15 PLOT FPOP 10^3 MultiTest Candidates.png",  width = 1500, height = 1000)
