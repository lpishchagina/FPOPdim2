...
###############################
length.simu <-NULL
length.simu <- seq(from = 1000, to = 10000, by = 1000)
...
write.table(tab.FPOP2, "Table Time complexity FPOP2 10^2-4.txt" )
write.table(mean.FPOP2, "Time complexity FPOP2 10^2-4.txt", row.names = FALSE, col.names = FALSE  )
###############################
#  Plot:time complexity FPOP2 #
###############################
png(filename = "Plot Time complexity FPOP2 10^2-4.png",  width = 1500, height = 1000)
...
png(filename = "Plot log10 Time complexity FPOP2 10^2-4.png",  width = 1500, height = 1000)
...
write.table(tab.OP, "Table Time complexity OP 10^2-4.txt" )
write.table(mean.OP, "Time complexity OP 10^2-4.txt",  row.names = FALSE, col.names = FALSE)
###############################
#  Plot:time complexity OP    #
###############################
png(filename = "Plot log10 Time complexity OP 10^2-4.png",  width = 1500, height = 1000)
...
png(filename = "Plot Time complexity OP 10^2-4.png",  width = 1500, height = 1000)
...
write.table(tab.PELT, "Table Time complexity PELT 10^2-4.txt" )
write.table(mean.PELT, "Time complexity PELT 10^2-4.txt", row.names = FALSE,col.names = FALSE  )
###############################
#  Plot:time complexity PELT  #
###############################
png(filename = "Plot log10 Time complexity PELT 10^2-4.png",  width = 1500, height = 1000)
...
png(filename = "Plot Time complexity PELT 10^2-4.png",  width = 1500, height = 1000)
...
write.table(tab.FPOP3, "Table Time complexity FPOP3 10^2-4.txt" )
write.table(mean.FPOP3, "Time complexity FPOP3 10^2-4.txt", row.names = FALSE,col.names = FALSE)
###############################
#  Plot:time complexity FPOP3 #
###############################
png(filename = "Plot log10 Time complexity FPOP3 10^2-4.png",  width = 1500, height = 1000)
...
png(filename = "Plot Time complexity FPOP3 10^2-4.png",  width = 1500, height = 1000)
...
write.table(tab.FPOP1, "Table Time complexity FPOP1 10^2-4.txt" )
write.table(mean.FPOP1, "Time complexity FPOP1 10^2-4.txt", row.names = FALSE, col.names = FALSE)
###############################
#  Plot:time complexity FPOP1 #
###############################
png(filename = "Plot log10 Time complexity FPOP1 10^2-4.png",  width = 1500, height = 1000)
...
png(filename = "Plot Time complexity FPOP1 10^2-4.png",  width = 1500, height = 1000)
...
png(filename = "Plot log10 Time complexity Comparison 10^2-4.png",  width = 1500, height = 1000)
  
  plot(log10(length.simu[1]), log10(mean.FPOP2[1]), col = "royalblue3", xlab = "lg(data length)", ylab = "lg(mean time in second)",  main = "Time complexity", ylim = c(min_lgy, max_lgy), xlim = c(min_lgx, max_lgx))
  lines(log10(length.simu[1]), log10(mean.FPOP2[1]), col = "royalblue3")
...
png(filename = "Plot Time complexity Comparison 10^2-4.png",  width = 1500, height = 1000)
