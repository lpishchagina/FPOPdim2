...
for(i in 1:length(length.simu)){
  ...
  res.nb.simu <- mclapply(1:nb.simu, FUN = one.simu.fpop, data1 = data[1,], data2 = data[2,], penalty = beta, type = 1, mc.cores = cores)
...
write.table(tab.FPOP1, "Table Time complexity FPOP1 1000-1000000.txt" )
write.table(mean.FPOP1, "Time complexity FPOP1 1000-1000000.txt" )
###############################
#  Plot:time complexity FPOP1 #
###############################
png(filename = "Plot Time complexity FPOP1 1000-1000000.png",  width = 1500, height = 1000)
...
#################################
#Plot:log(time complexity FPOP1)#
#################################
png(filename = "Plot Time complexity FPOP1 1000-1000000 log.png",  width = 1500, height = 1000)
plot(log(length.simu), log(mean.FPOP1), xlab = "log(Data length)", ylab = "log(Mean time in second)",  main = "Time complexity of FPOP1", col = "steelblue")
lines(length.simu, mean.FPOP1, col="steelblue")
dev.off()
#################################
#Plot:log(time complexity FPOP1)#
#################################
png(filename = "Plot Time complexity FPOP1 1000-1000000 log2.png",  width = 1500, height = 1000)
plot(log(length.simu), mean.FPOP1, xlab = "log(Data length)", ylab = "Mean time in second",  main = "Time complexity of FPOP1", col = "steelblue")
lines(length.simu, mean.FPOP1, col="steelblue")
dev.off()
