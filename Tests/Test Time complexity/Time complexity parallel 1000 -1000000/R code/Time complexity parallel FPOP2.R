...
for(i in 1:length(length.simu)){
  ...
  res.nb.simu <- mclapply(1:nb.simu, FUN = one.simu.fpop, data1 = data[1,], data2 = data[2,], penalty = beta, type = 2, mc.cores = cores)
...
write.table(tab.FPOP2, "Table Time complexity FPOP2 1000-1000000.txt" )
write.table(mean.FPOP2, "Time complexity FPOP2 1000-1000000.txt" )
###############################
#  Plot:time complexity FPOP2 #
###############################
png(filename = "Plot Time complexity FPOP2 1000-1000000.png",  width = 1500, height = 1000)
...
#################################
#Plot:log(time complexity FPOP2)#
#################################
png(filename = "Plot Time complexity FPOP2 1000-1000000 log.png",  width = 1500, height = 1000)
plot(log(length.simu), log(mean.FPOP2), xlab = "log(Data length)", ylab = "log(Mean time in second)",  main = "Time complexity of FPOP2", col = "steelblue")
lines(length.simu, mean.FPOP2, col="steelblue")
dev.off()
#################################
#Plot:log(time complexity FPOP2)#
#################################
png(filename = "Plot Time complexity FPOP21000-1000000 log2.png",  width = 1500, height = 1000)
plot(log(length.simu), mean.FPOP2, xlab = "log(Data length)", ylab = "Mean time in second",  main = "Time complexity of FPOP2", col = "steelblue")
lines(length.simu, mean.FPOP2, col="steelblue")
dev.off()
