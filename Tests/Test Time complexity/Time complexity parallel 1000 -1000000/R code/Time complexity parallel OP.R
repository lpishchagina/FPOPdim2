...
for(i in 1:length(length.simu)){
  ...
  res.nb.simu <- mclapply(1:nb.simu, FUN = one.simu.op, data1 = data[1,], data2 = data[2,], penalty = beta, type = "null", mc.cores = cores)
...
###############################
png(filename = "Plot Time complexity OP 1000-1000000.png",  width = 1500, height = 1000)
...
###############################
# Plot:log(time complexity OP)#
###############################
png(filename = "Plot Time complexity OP 1000-1000000 log.png",  width = 1500, height = 1000)
plot(log(length.simu), log(mean.OP), xlab = "log(Data length)", ylab = "log(Mean time in second)",  main = "Time complexity of OP", col = "steelblue")
lines(length.simu, mean.OP, col="steelblue")
dev.off()
###############################
# Plot:log(time complexity OP)#
###############################
png(filename = "Plot Time complexity OP 1000-1000000 log2.png",  width = 1500, height = 1000)
plot(log(length.simu), mean.OP, xlab = "log(Data length)", ylab = "Mean time in second",  main = "Time complexity of OP", col = "steelblue")
lines(length.simu, mean.OP, col="steelblue")
dev.off()
