...
png("Plot FPOP3 Exclusions data25000.png",  width = 1500, height = 1000)
...
write.table(c(v_mean_plot, 0), "FPOP3 Mean number of exclusions data25000.txt",  row.names = FALSE,col.names = FALSE  ) 
